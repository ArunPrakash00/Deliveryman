package com.beginnersluckstrikes.delivery.Config;
...
public class BaseURL {
    ...
    public static String BASE_URL = "http://beginnersluckstrikes.in/";
    public static String Loction = "http://beginnersluckstrikes.in/farmer/index.php/api/update_location";
    ...
    public static final String urlUpload = "http://beginnersluckstrikes.in/index.php/api/mark_delivered2";
